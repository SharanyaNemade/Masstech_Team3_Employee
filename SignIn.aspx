<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="Masstech_Team3.SignIn" %>
								...
								<div class="vh-100">
									<div class="vh-100 d-flex flex-column justify-content-center p-4">
										<div class=" mx-auto mb-5 text-center position-relative">
											...
											<img id="Image1" class="img-fluid" src="https://localhost:44323/Uploads/logos/17d7a359-585b-436b-a0c0-55e10f8eff3d.png">
										...
										<div class="">
											...
											<div class="mb-3">
												<asp:Button ID="Button1" class="btn btn-primary w-100" runat="server" Text="Sign In" OnClick="Button1_Click" />
											</div>
                                            <div class="login-or">
										...
										<div class="mt-5 pb-4 text-center">
											<p class="mb-0 text-gray-9">Copyright &copy; 2025 - @ViewBag.name</p>
										</div>
										</div>
								</div>
                            </div>
